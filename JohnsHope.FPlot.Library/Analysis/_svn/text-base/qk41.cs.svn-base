namespace JohnsHope.Analysis {
	...
	public partial class Int {
		static double[] xgk_41 = new double[21]  /* abscissae of the 41-point kronrod rule */
		{
		...
		static double[] wg_41 = new double[11]   /* weights of the 20-point gauss rule */
		{
		...
		static double[] wgk_41 = new double[21]   /* weights of the 41-point kronrod rule */
		{
		...
		static double[] fv1_41 = new double[21], fv2_41 = new double[21];

		static void	gsl_integration_qk41(IFunction1D f, double a, double b,
													out double result, out double abserr,
													out double resabs, out double resasc, Workspace workspace) {
			lock (fv1_41) {
				gsl_integration_qk(21, xgk_41, wg_41, wgk_41, fv1_41, fv2_41, f, a, b, out result, out abserr, out resabs, out resasc, workspace);
			}
		}

		static void gsl_integration_qk41(Function1DDelegate f, double a, double b,
											out double result, out double abserr,
											out double resabs, out double resasc, Workspace workspace) {
			lock (fv1_41) {
				gsl_integration_qk(21, xgk_41, wg_41, wgk_41, fv1_41, fv2_41, f, a, b, out result, out abserr, out resabs, out resasc, workspace);
