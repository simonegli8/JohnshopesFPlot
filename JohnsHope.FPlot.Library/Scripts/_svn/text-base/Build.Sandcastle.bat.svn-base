...
set OLDPATH=%PATH%
set PATH=%windir%\Microsoft.NET\Framework\v2.0.50727;%DXROOT%\ProductionTools;%ProgramFiles%\HTML Help Workshop;%ProgramFiles%\Microsoft Help 2.0 SDK;%ProgramFiles%\Common Files\microsoft shared\Help 2.0 Compiler;%PATH%
